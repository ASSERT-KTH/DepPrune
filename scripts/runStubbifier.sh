...
do
    ...
    echo -n "" > Playground/stubbifier_bloated_file.txt
    ...
    cp Playground/stubbifier_bloated_file.txt 'Playground/'$projectName'_stubbifier_bloated_file'.txt

    cd ..

    python3 extract_difference_stubbifier.py $projectName "all_files_in_stubbifier.txt" "stubbifier_bloated_file.txt" "stubbifier_accessed_files.txt"

    python3 extract_bloated_deps_stubbifier.py $projectName
